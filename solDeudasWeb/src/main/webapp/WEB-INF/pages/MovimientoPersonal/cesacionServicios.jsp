			...
			<div class="row">
				<div class="col-12">
					<div class="p-1 text-white bg-primary">
						<h5 class="card-title-2">Movimiento Personal: Cesaci&oacute;n de Servicios</h5>
					</div>
						...
						<div class="row col-lg-12">
							<table class="tabla-dos" width="100%">
								<tr>
									...
									<th><center>Finiquito</center></th>
									<th><center>Carta Renuncia</center></th>	
									<th><center>Decla Mov. Pers.</center></th>																
								</tr>
								<tr>
