/**
 * GetCertDetDeudaResponseCondicion.java
 *
...
public class GetCertDetDeudaResponseCondicion  implements java.io.Serializable {
    private int codigoRespuesta;

    private java.lang.String descripcionRespuesta;

    public GetCertDetDeudaResponseCondicion() {
    }
    ...
    /**
     * Gets the codigoRespuesta value for this GetCertDetDeudaResponseCondicion.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this GetCertDetDeudaResponseCondicion.
     * 
    ...
    /**
     * Gets the descripcionRespuesta value for this GetCertDetDeudaResponseCondicion.
     * 
    ...
    /**
     * Sets the descripcionRespuesta value for this GetCertDetDeudaResponseCondicion.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCertDetDeudaResponseCondicion)) return false;
        GetCertDetDeudaResponseCondicion other = (GetCertDetDeudaResponseCondicion) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCertDetDeudaResponseCondicion.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://afphabitat.cl/soap/certificado", ">>getCertDetDeudaResponse>condicion"));
