/**
 * GetCertDeudaResponseCondicion.java
 *
...
public class GetCertDeudaResponseCondicion  implements java.io.Serializable {
    private int codigoRespuesta;

    private java.lang.String descripcionRespuesta;

    public GetCertDeudaResponseCondicion() {
    }
    ...
    /**
     * Gets the codigoRespuesta value for this GetCertDeudaResponseCondicion.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this GetCertDeudaResponseCondicion.
     * 
    ...
    /**
     * Gets the descripcionRespuesta value for this GetCertDeudaResponseCondicion.
     * 
    ...
    /**
     * Sets the descripcionRespuesta value for this GetCertDeudaResponseCondicion.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCertDeudaResponseCondicion)) return false;
        GetCertDeudaResponseCondicion other = (GetCertDeudaResponseCondicion) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCertDeudaResponseCondicion.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://afphabitat.cl/soap/certificado", ">>getCertDeudaResponse>condicion"));
