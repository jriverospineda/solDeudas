/**
 * GetCertMoraPresuntaResponseCondicion.java
 *
...
public class GetCertMoraPresuntaResponseCondicion  implements java.io.Serializable {
    private int codigoRespuesta;

    private java.lang.String descripcionRespuesta;

    public GetCertMoraPresuntaResponseCondicion() {
    }
    ...
    /**
     * Gets the codigoRespuesta value for this GetCertMoraPresuntaResponseCondicion.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this GetCertMoraPresuntaResponseCondicion.
     * 
    ...
    /**
     * Gets the descripcionRespuesta value for this GetCertMoraPresuntaResponseCondicion.
     * 
    ...
    /**
     * Sets the descripcionRespuesta value for this GetCertMoraPresuntaResponseCondicion.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCertMoraPresuntaResponseCondicion)) return false;
        GetCertMoraPresuntaResponseCondicion other = (GetCertMoraPresuntaResponseCondicion) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCertMoraPresuntaResponseCondicion.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://afphabitat.cl/soap/certificado", ">>getCertMoraPresuntaResponse>condicion"));
