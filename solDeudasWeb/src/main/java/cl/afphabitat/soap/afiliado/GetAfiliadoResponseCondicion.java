/**
 * GetAfiliadoResponseCondicion.java
 *
...
public class GetAfiliadoResponseCondicion  implements java.io.Serializable {
    private int codigoRespuesta;

    private java.lang.String descripcionRespuesta;

    public GetAfiliadoResponseCondicion() {
    }
    ...
    /**
     * Gets the codigoRespuesta value for this GetAfiliadoResponseCondicion.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this GetAfiliadoResponseCondicion.
     * 
    ...
    /**
     * Gets the descripcionRespuesta value for this GetAfiliadoResponseCondicion.
     * 
    ...
    /**
     * Sets the descripcionRespuesta value for this GetAfiliadoResponseCondicion.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAfiliadoResponseCondicion)) return false;
        GetAfiliadoResponseCondicion other = (GetAfiliadoResponseCondicion) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAfiliadoResponseCondicion.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://afphabitat.cl/soap/afiliado", ">>getAfiliadoResponse>condicion"));
